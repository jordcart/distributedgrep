...
./mrsequential ../mrapps/wc.so ../../testfiles/pg-*.txt || exit 1
sort mr-out-0 > mr-correct-wc.txt
rm -f mr-out*

echo '***' Starting wc test.

timeout -k 2s 180s ./mrmaster ../../testfiles/pg-*.txt &
...
# generate the correct output
./mrsequential ../mrapps/indexer.so ../../testfiles/pg*txt || exit 1
...
# generate the correct output
./mrsequential ../mrapps/nocrash.so ../../testfiles/pg*txt || exit 1
...
rm -f mr-done
(timeout -k 2s 180s ./mrmaster ../../testfiles/pg*txt ; touch mr-done ) &
sleep 1
